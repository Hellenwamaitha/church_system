<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <form action="<?php echo e(route('financialreport.filter')); ?>" method="GET" class="mb-4">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">$<?php echo e(number_format($totalOfferings, 2)); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">$<?php echo e(number_format($totalTithes, 2)); ?></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">$<?php echo e(number_format($totalIncome, 2)); ?></p>
                    </div>
                </div>
            </div>
        </div>
        <table class="table table-hover">
            ...
            <tbody>
                <?php $__currentLoopData = $financialReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($report->total_offerings); ?></td>
                        <td><?php echo e($report->total_tithes); ?></td>
                        <td><?php echo e($report->total_income); ?></td>
                        <td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addReportForm" method="POST" action="<?php echo e(route('financialreport.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hellen/managementapp/resources/views/financialreport/index.blade.php ENDPATH**/ ?>